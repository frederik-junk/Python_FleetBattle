...
class TestShipmanager(unittest.TestCase):
    def setUp(self):
        self.schlachtSchiff = Schlachtschiff(1, 4)
        self.kreuzer = Kreuzer(2, 2)

    def test_getName(self):
        self.assertEqual(self.schlachtSchiff.getName(), "Schlachtschiff(1x)")
        self.assertEqual(self.schlachtSchiff.getSize(), 5)
        self.assertEqual(self.kreuzer.getName(), "Kreuzer(2x)")
