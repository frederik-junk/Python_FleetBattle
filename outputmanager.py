    ...
    match winningID:
        case 1:
            if gameMode == 1:  # computer wins the game (1 Player mode)
                ...
                print(
                    colored(
                        f"{user1.getName()} hat das Spiel gewonnen. {user2.getName()} versuche es doch noch einmal!",
                        "magenta",
                    )
                )
            else:
                ...
                print(
                    colored(
                        f"Herzlichen Glueckwunsch {user1.getName()} du hast das Spiel gegen {user2.getName()} gewonnen!",
                        "green",
                    )
                )
        case 2:
            if gameMode == 1:  # player wins the game (1 Player mode)
                ...
                print(
                    colored(
                        f"Herzlichen Glueckwunsch {user2.getName()} du hast das Spiel gegen den Computer gewonnen!",
                        "green",
                    )
                )
            else:
                ...
                print(
                    colored(
                        f"Herzlichen Glueckwunsch {user2.getName()} du hast das Spiel gegen {user1.getName()} gewonnen!",
                        "green",
                    )
                )
        case _:
...
def welcomeUser():
    ...
    print(
        colored(
            "|_|    |_|\___|\___|\__| |____/ \__,_|\__|\__|_|\___|  ",
            "cyan",
            attrs=["blink"],
        )
    )
...
def loseoutput():
    ...
    print(
        colored(
            " _   _   _____   ______   _____    ______   _____    _                    _____   ______",
            "red",
        )
    )
    print(
    ...
    print(
        colored(
            "| |\  |  _| |_  | |____  | |__| | | |____  | | \ \  | |____   / ____ \  | |__| | | |____   ",
            "red",
        )
    )
    print(
        colored(
            "|_| \_| |_____| |______| |_____/  |______| |_|  \_\ |______| /_/    \_\  \_____| |______|  ",
            "red",
        )
    )
    print(
